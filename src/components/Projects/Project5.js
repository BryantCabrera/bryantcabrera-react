    ...
    render() {
        return (      
            <div className="project2 project__card">
                ...
                <a href="https://github.com/BryantCabrera/gameplay-react" target="_blank" rel="noopener noreferrer" className="project__img--link"><img src="/imgs/gameplay.png" alt="GamePlay Project" title="GamePlay Project" className="project__img"></img></a>
